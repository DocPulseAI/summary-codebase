...
def test_generate_summary_returns_pipeline_metadata_envelope():
    ...
    with patch("epic4.api.SummaryGenerator.generate", return_value=("/tmp/summary.md", "/tmp/summary.json")), \
         patch("builtins.open") as open_mock, \
         patch("epic4.api._upload_summary_artifacts", return_value={"uploaded": True, "bucket_path": "x", "files": ["summary.md", "summary.json"], "error": None}):
